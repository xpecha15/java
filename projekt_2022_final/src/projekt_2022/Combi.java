...
public class Combi extends Student {
	
	public Combi(String surname, String lastname,int id, int day, int month, int year, double average) {
	...
	public void saySomeExtra() {
		...
		if(year%4==0) System.out.print("rok mého narození je pøestupným.");
